...
collections:
  - "Lomax Collection"
youtubeEmbedUrl: "https://www.youtube.com/embed/kjBZEMkmwYA?si=JmbQNg_zZdV79_nP"
...
The [Lomax Collection](/collections/lomax-collection), assembled by John and Alan Lomax across several decades of fieldwork, provides the primary archival home for this song in institutional terms, though the collection itself spans the late nineteenth through mid-twentieth centuries and was assembled under complex conditions that scholars evaluate carefully. See our [bibliography](/sources) for details on the sources cited in this entry.
